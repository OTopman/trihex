 ...
 */
export const ICOSAHEDRON_VERTICES: Vector3D[] = [
  [-A,  B,  0], // 0
  [ A,  B,  0], // 1
  [-A, -B,  0], // 2
  [ A, -B,  0], // 3
 ...
 */
export const FACE_NORMALS: Vector3D[] = ICOSAHEDRON_FACES.map(([i0, i1, i2]) => {
 ...
 */
export const FACE_CENTROIDS: Vector3D[] = ICOSAHEDRON_FACES.map(([i0, i1, i2]) => {
  const v0 = ICOSAHEDRON_VERTICES[i0];
  const v1 = ICOSAHEDRON_VERTICES[i1];
  const v2 = ICOSAHEDRON_VERTICES[i2];
