...
exports.evaluateCandidateRecall = evaluateCandidateRecall;
...
function createRiverBarrierTopology() {
    const graph = new topology_1.VersionedRoadGraph('river-barrier-v1');
    // South bank (Island)
...
function createHighwayTopology() {
    const graph = new topology_1.VersionedRoadGraph('highway-v1');
