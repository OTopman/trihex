import { TriHexId, DriverStatus, CandidateScoring } from './trihex-bridge';
...
export interface TelemetryPing {
  ...
  speedKmh: number;
  headingDeg: number;
  version: number;     // Monotonic incrementing sequence token for the driver
...
export interface DispatchRequest {
  ...
  riderLat: number;
  riderLng: number;
  radiusCells?: number; // k-ring search radius around rider
