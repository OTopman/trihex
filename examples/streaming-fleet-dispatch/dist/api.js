...
exports.DispatchApiService = void 0;
...
class DispatchApiService {
    ...
    async dispatch(request) {
        ...
        const riderCellId = (0, trihex_bridge_1.latLngToCell)(request.riderLat, request.riderLng, this.config.resolution);
        const riderCellHex = (0, trihex_bridge_1.cellToString)(riderCellId);
        // 2. Expand search space via cellDisk
        const candidateCells = (0, trihex_bridge_1.cellDisk)(riderCellId, radius);
...
exports.DispatchApiService = DispatchApiService;
